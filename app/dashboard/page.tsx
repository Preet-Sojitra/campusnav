...
function RouteCard({
  ...
  route: import("../context/ScheduleContext").RouteEntry;
}) {
  ...
  return (
    ...
    >
      ...
      {route.freeRoomSuggestion && !loading && !error && (
        <div
        ...
        >
          <div className="flex items-start gap-2">
            <span className="mt-0.5">
              {route.freeRoomSuggestion.status === "good"
                ? "✨"
                : route.freeRoomSuggestion.status === "tight"
                  ? "⏱️"
                  : "⚠️"}
            </span>
            <div>
              <p
                ...
                style={{ color: "var(--color-text-primary)" }}
              >
                {route.freeRoomSuggestion.message}
              </p>
              {route.freeRoomSuggestion.usableMinutes > 0 &&
                route.freeRoomDirectionsUrl &&
                route.nextClassDirectionsUrl && (
                  <div className="mt-2 flex flex-col gap-1 text-xs sm:flex-row sm:gap-4">
                    <a
                      href={route.freeRoomDirectionsUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="font-medium underline hover:opacity-80"
                      style={{ color: "var(--color-primary)" }}
                    >
                      To Library ({route.freeRoomFormattedDuration})
                    </a>
                    <a
                      href={route.nextClassDirectionsUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="font-medium underline hover:opacity-80"
                      style={{ color: "var(--color-primary)" }}
                    >
                      To Class ({route.nextClassFormattedDuration})
                    </a>
                  </div>
                )}
            </div>
